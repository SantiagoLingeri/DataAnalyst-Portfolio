...
/* Missing hire dates can be saved from contracts info (57 missing) */
...
/* Missing salaries can be replaced with average salary (5 missing) */
...
/* Deleting entries with incomplete job titles (11 missing) */
